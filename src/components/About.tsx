  ...
  return (
    ...
    >
      <div className=" md:w-3/5 w-full pb-10    ">
        <div className="  font-gilroy  max-md:text-center font-semibold pb-20  relative ">
          About Sabu Cyril
          <div className=" absolute  bottom-16 md:w-1/2 w-full h-1 bg-gradient-to-r from-transparent to-transparent via-primary "></div>
        </div>
