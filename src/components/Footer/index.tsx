      ...
      <div className=" mx-auto flex flex-col gap-10  md:flex-row md:items-start items-center md:px-10 px-6     justify-between">
        <div className="mb-6 md:mb-0 flex flex-col ">
          ...
          <div className="flex items-center max-md:justify-center gap-3  md:pt-5  pt-3 ">
            <a
              href="https://youtube.com/@Trinity-VR"
              target="_blank"
            ...
            <a
              href="https://x.com/Trinity_xr?t=22DISG_bpxG0S1uoebcgFg&s=09"
              target="_blank"
              className="inline-block text-[#dfdfe0] hover:text-white pl-4 "
            >
              <svg
            ...
            <a
              href="https://www.instagram.com/explore.trinityxr/"
              target="_blank"
              className="inline-block text-[#dfdfe0] hover:text-white pl-4 "
            >
              <svg
            ...
            <a
              href="https://www.linkedin.com/company/trinity-xr/"
              target="_blank"
              className="inline-block text-[#dfdfe0] hover:text-white pl-4 "
            >
              <svg
