...
const Footer = () => {
  return (
    <div className="bg-black bg-opacity-80 text-white w-full font-poppins">
      <footer className="max-w-7xl mx-auto px-6 md:px-10 py-10">
        <div className="flex flex-col md:flex-row md:items-start items-center justify-between gap-10">
          {/* Left Block - Logo and Socials */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <img src={footer} alt="Sabu Cyril Logo" className="h-12 w-auto object-contain" />
            <p className="text-[#C3C3C4] pt-4">© 2025 Sabu Cyril Design Unlimited</p>
            ...
            <div className="flex gap-4 pt-4 justify-center md:justify-start">
              ...
              {[
                ...
                <a
                  ...
                  aria-label={title}
                  className="text-[#dfdfe0] hover:text-white transition-colors"
                >
                  {svg}
                </a>
              ))}
          ...
          <div className="flex flex-col md:flex-row w-full md:justify-end gap-8 text-left md:text-left">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={href}>
                    <a
                      href={href}
                      className="text-[#C3C3C4] hover:text-white transition-colors"
                    >
                      {label}
                    </a>
                  </li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="mailto:sabucyril@gmail.com"
                    className="text-[#C3C3C4] hover:text-white transition-colors"
                  >
                    sabucyril@gmail.com
                  </a>
                ...
                {/* <li>
                  <a href="tel:+919948348899" className="text-[#C3C3C4] hover:text-white">+(91) 99483 48899</a>
                </li> */}
              </ul>
            </div>
          </div>
